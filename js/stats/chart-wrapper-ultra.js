...
export function createStatsCard(containerId, options) { const container = document.getElementById(containerId); if (!container) { console.error("Container " + containerId + " not found"); return; }
...
applyPremiumEffects(container.querySelector('.stats-card'));

}

function drawRadarChart(ctx, data) { const canvas = ctx.canvas; canvas.width = 300; canvas.height = 300;
...
function drawRingsChart(ctx, data) { const canvas = ctx.canvas; canvas.width = 300; canvas.height = 300;
...
function drawZonesChart(ctx, data) { const canvas = ctx.canvas; canvas.width = 300; canvas.height = 200;
...
function drawVolumeChart(ctx, data) { const canvas = ctx.canvas; canvas.width = 300; canvas.height = 200;
...
function drawScoreChart(ctx, data) { const canvas = ctx.canvas; canvas.width = 300; canvas.height = 200;
...
function applyPremiumEffects(container) { // Ajouter les classes premium container.classList.add('glow-effect', 'has-particles');
